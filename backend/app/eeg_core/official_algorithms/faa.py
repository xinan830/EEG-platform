"""Frozen official FAA calculation contract.

This module owns the implementation; :mod:`app.eeg_core.faa` is retained as a
...
def compute_faa(f3, f4, sfreq, epoch_s=FAA_EPOCH_S, overlap=FAA_EPOCH_OVERLAP,
    ...
    """Compute paired-epoch ``ln(P_F4) - ln(P_F3)`` without changing its contract."""
