...
stream in preview mode before navigating from preparation to the live acquisition
workspace. Preview mode SHALL NOT create a raw manifest, sample chunk, or audit
record. Raw persistence SHALL begin only after the user explicitly starts recording.
