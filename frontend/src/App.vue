...
function updateDynamicAlgorithmSession(value: { enabled: boolean; definitions: Array<{ id: string; label: string; unit: string; channel: string; windowS: number; displayRangeS: number }> }) {
